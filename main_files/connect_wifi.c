...
#define WIFI_CONNECTED_BIT BIT0  // Connected
...
// Function to initiate Wi-Fi connection in station mode
void connect_wifi(void) {
    ...
    vEventGroupDelete(s_wifi_event_group);  // Clean up event group after use
}
